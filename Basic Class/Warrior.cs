...
public class Warrior
{
    ...
    public int HealthPoints { get => this.healthpoints; set => healthpoints = value; }
    public string Name { get=> this.name; set => this.name = value ; }
    public Sword Weapon { get => this.weapon;
        set => this.weapon = value;
    }
    public Warrior(int damage, int healthPoints, string name, Sword weapon)
    {
        this.Damage = damage;
    ...
    {
        enemyWarrior.HealthPoints -= Damage;
    }
